...
function About({ isDarkMode }) {
    return (<section id="about" className="min-h-screen flex items-center justify-center p-8 pt-24 lg:pt-8 transition-colors duration-300">
      <div className="max-w-3xl">
        ...
        <div className={`p-8 md:p-12 rounded-2xl border-2 transition-colors duration-300 ${isDarkMode
          ...
          <div className="space-y-4">
            <div className={`p-4 rounded-xl border-l-4 transition-colors duration-300 ${isDarkMode
          ...
          {/* Action Modules */}
          <div className="flex gap-4 pt-6 mt-6 border-t-2 border-dashed transition-colors duration-300" style={{ borderColor: isDarkMode ? '#334155' : '#e2e8f0' }}>
            <a href="#contact" className={`px-6 py-3 rounded-lg transition-colors border-2 ${isDarkMode
            ...
            <a href="#work" className={`px-6 py-3 border-2 rounded-lg transition-colors ${isDarkMode
